...
public class List
{
    ...
    * */
    ...
    /**
    * Appends the current list data to the specified file
     *
     * @param fileName Full path of the createt file
    * */
     ...
     *
     *
     * @param fileName Full path of the parsed file
     * */
